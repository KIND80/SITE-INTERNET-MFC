...
const EngagementPage = () => {
  ...
  const scrollToContact = (e) => {
    ...
    if (contactSection) {
      ...
      // Si la section n'est pas sur la même page, naviguer puis scroller
      // Pour l'instant, un simple Link suffit car la cible est sur la page d'accueil
    }
  };
    ...
    <div className="bg-white">
      ...
      <section className="py-24 bg-secondary text-white text-center">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Le bouton est maintenant un Link qui pointe vers la page d'accueil et la section #contact */}
